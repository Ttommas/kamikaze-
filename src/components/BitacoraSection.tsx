...
import { Play, FileText, X, Clock, User, ArrowRight, Video, Youtube, ExternalLink } from 'lucide-react';
    ...
    <section id="bitacora" className="border-b border-[#E52E33] scroll-mt-16">
      ...
      {selectedNote && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/65 backdrop-blur-xs">
          <div className="bg-[#FFD41D] text-[#E52E33] border-2 border-[#E52E33] w-full max-w-2xl p-6 sm:p-8 shadow-2xl space-y-4 max-h-[85vh] overflow-y-auto">
            <div className="flex justify-between items-center border-b border-[#E52E33] pb-3">
              ...
              <button onClick={() => setSelectedNote(null)} className="p-1 border border-[#E52E33] hover:bg-[#E52E33] hover:text-[#FFD41D]">
                <X className="w-4 h-4" />
              </button>
            </div>
      ...
      {isPlayingVideo && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/85 backdrop-blur-sm">
          <div className="bg-[#FFD41D] text-[#E52E33] border-2 border-[#E52E33] w-full max-w-4xl p-4 sm:p-6 shadow-2xl space-y-4">
            <div className="flex justify-between items-center border-b border-[#E52E33] pb-3">
              ...
              <button 
                ...
                className="p-1 border border-[#E52E33] hover:bg-[#E52E33] hover:text-[#FFD41D]"
              >
                <X className="w-5 h-5" />
              </button>
            </div>
            ...
            <div className="relative w-full aspect-video bg-black border border-[#E52E33]">
              <iframe
                src={embedUrl}
            ...
            <div className="flex flex-col sm:flex-row justify-between items-center text-xs font-mono gap-2">
              <span className="opacity-90">{videoConfig.description}</span>
              <div className="flex items-center gap-3 shrink-0">
                ...
                <button
                  onClick={() => setIsPlayingVideo(false)}
                  className="btn-brand-inverse px-4 py-1.5 uppercase font-bold cursor-pointer"
                >
                  Cerrar
                </button>
              </div>
